...
require_once('C:\\xampp\mysqli_connect_MBoard.php');
...
echo '<li class="dropdown"><a href="forum.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">' . $words['languages'] . ' <span class="caret"></span></a>
